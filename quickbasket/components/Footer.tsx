        ...
        <div className='w-[90%] md:w-[80%] mx-auto py-10 grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-green-500/40'>
          <div>
            <div className='flex items-center gap-2 mb-4'>
                <img src='./favicon.ico' className='h-7 w-9 '></img>
...
<div >
    ...
    <ul className='space-y-2 text-green-100 text-sm'>
        ...
        <li><Link href={"/user/myOrder"} className='hover:text-white transition'>My Orders</Link></li>
    </ul>
</div>
...
<div>
     <h3 className="text-xl font-semibold mb-3">Contact Us</h3>
          <ul className="space-y-2 text-green-100 text-sm">
            ...
            <li className="flex items-center gap-2">
              <Mail size={16} /> support@quickbasket.in
            </li>
          </ul>
          {/* 🌐 Social Links */}
