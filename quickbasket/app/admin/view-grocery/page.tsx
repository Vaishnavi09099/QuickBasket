          ...
          <span className="text-base">Back to store</span>
            ...
            <div className='space-y-4'>
                {fillterd?.map((g, i) => (
                    ...
                    >
                        <div className='relative w-full sm:w-30 aspect-square rounded-xl overflow-hidden border border-gray-200'>
                            <Image
                                src={g.image}
                                alt={g.name}
                                fill
            ...
            <AnimatePresence>
                {editing && (
                    ...
                    >
                      ...
                      <div className='relative h-40 w-full rounded-lg overflow-hidden mb-4 border border-gray-200 group'>
                         {imagePreview && <Image
                         src={imagePreview}
                         alt={editing.name}
                         fill
